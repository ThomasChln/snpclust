...
plot_pca_pairs(1:3, snpclust_object$pca, 'population')
plot_pca_pairs(4:6, snpclust_object$pca, 'population')
```
...
```{r}
ggplot_pca(snpclust_object$features_pca, 'population', ellipses = TRUE)
plot_pca_pairs(1:3, snpclust_object$features_pca, 'population')
plot_pca_pairs(4:6, snpclust_object$features_pca, 'population')
```
