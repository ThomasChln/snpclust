...
plot_pca_pairs(axes = 1:3, pcafort = snpclust_object$pca, groups = 'population')
plot_pca_pairs(axes = 4:6, pcafort = snpclust_object$pca, groups = 'population')
```
...
plot_pca_pairs(axes = 1:3, pcafort = snpclust_object$features_pca, groups = 'population')
plot_pca_pairs(axes = 4:6, pcafort = snpclust_object$features_pca, groups = 'population')
```
