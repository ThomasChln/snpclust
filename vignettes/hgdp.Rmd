...
The HGDP files are first converted to the Genomic Data Structure (GDS) format (cf. R package gdsfmt).
...
```{r}
ggplot_pca(qb_pcafort = snpclust_object$pca, groups = 'population', ellipses = TRUE)
plot_pca_pairs(axes = 1:3, qb_pcafort = snpclust_object$pca, groups = 'population')
plot_pca_pairs(axes = 4:6, qb_pcafort = snpclust_object$pca, groups = 'population')
```
...
```{r}
ggplot_pca(qb_pcafort = snpclust_object$features_pca, groups = 'population', ellipses = TRUE)
plot_pca_pairs(axes = 1:3, qb_pcafort = snpclust_object$features_pca, groups = 'population')
plot_pca_pairs(axes = 4:6, qb_pcafort = snpclust_object$features_pca, groups = 'population')
```
